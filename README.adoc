...
https://en.wikipedia.org/wiki/John_Gall_(author)#Gall's_law[Gall's Law]
...
https://en.wiktionary.org/wiki/Gell-Mann_Amnesia_effect[Gell-Mann Amnesia effect]

[sidebar]
The phenomenon of a person trusting a source for topics which that person is not knowledgeable about, despite recognizing the source as being extremely inaccurate on certain topics which that person is knowledgeable about.
...
https://blog.octo.com/pour-en-finir-avec-la-loi-de-moore[La loi d'EROOM de Tristan Nitot]

NOTE: «EROOM» is a wordplay on reversing https://en.wikipedia.org/wiki/Moore's_law[Moore's Law] and backronyming it to the french «Effort Radicalement Organisé d'Optimisation en Masse» (which can be loosely translated to «Massive and radically organized optimization effort»).
